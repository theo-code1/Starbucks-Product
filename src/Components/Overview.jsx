    ...
    return (
        <section className="overview-section h-[110dvh] md:h-[100dvh] lg:h-screen pt-4 bg-gradient-to-r from-green to-light-green relative overflow-hidden ">
            <div className="Product">
                <img src={StarCoffee} alt="Ice Coffee" draggable={false} className='animate-go-up size-[110dvw] lg:size-[45rem] md:size-[85vw] absolute left-1/2 top-1/2 -translate-y-2/3 -translate-x-1/2 md:-translate-y-3/5 lg:-translate-1/2 rotate-18 z-20 select-none' />
