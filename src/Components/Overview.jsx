...
const Dashboard = () => {
    return (
        <section className="overview-section h-[120dvh] md:h-[100dvh] lg:h-screen pt-4 bg-gradient-to-r from-green to-light-green relative overflow-hidden ">
            ...
            <div className="left-b-text hidden text-white gap-0 h-auto md:w-2/5 lg:w-3/10 absolute md:bottom-4 lg:bottom-8 md:flex flex-col  left-6 animate-go-right">
